...
contract YieldToken is IYieldToken, ERC20PermitUpgradeable {
     ...
     */
    function initialize(string calldata _name, string calldata _symbol, address _pt) external initializer {
     ...
     */
    function burnWithoutYieldUpdate(address owner, address caller, uint256 amount) external override {
        if (msg.sender != pt) {
     ...
     */
    function decimals() public view virtual override(IYieldToken, ERC20Upgradeable) returns (uint8) {
     ...
     */
    function balanceOf(address account) public view override(IYieldToken, ERC20Upgradeable) returns (uint256) {
     ...
     */
    function _update(address from, address to, uint256 value) internal virtual override whenPTNotPaused {
