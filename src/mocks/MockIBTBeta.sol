...
import {SpectraERC4626Upgradeable} from "./base/SpectraERC4626Upgradeable.sol";
import {IMockToken} from "src/interfaces/IMockToken.sol";
...
contract MockIBTBeta is ERC20Upgradeable, SpectraERC4626Upgradeable, Ownable2StepUpgradeable {
     ...
     */
    function initialize(string memory _name, string memory _symbol, IERC20Metadata _asset) public initializer {
    ...
    function redeem(uint256 shares, address receiver, address owner)
        public
        override(SpectraERC4626Upgradeable)
