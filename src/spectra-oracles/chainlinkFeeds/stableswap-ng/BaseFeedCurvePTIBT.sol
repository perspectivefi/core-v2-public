 ...
 * @notice Base contract to implement the AggregatorV3Interface feed for the PT price expressed in IBT
 */
abstract contract BaseFeedCurvePTIBTSNG is BaseOracleCurvePT {
     ...
     */
    function __BaseFeedCurvePTIBTSNG_init(address _pt, address _pool) internal onlyInitializing {
